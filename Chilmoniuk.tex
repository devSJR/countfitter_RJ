...
In case the server is down or access to the Internet is restricted, 
%For more convenient 
access to the package’s capabilities, a graphical user interface (GUI) can be used by typing the \emph{countfitteR\_gui()} into the R console. A new window opens (Figure \ref{fig_gui}). 
