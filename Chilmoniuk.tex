...
\emph{countfitteR} can also be used from the command line. It has following main functions:

\begin{itemize}
    \item \textit{fit\_counts} is used to create a list of parameters characterizing chosen distribution model.
    \item \textit{compare\_fit} compares empirical distribution of counts with the distribution defined by the model fitted to counts.
    \item \textit{plot\_fitcmp} creates plot from compare\_fit results. 
    \item \textit{summary\_fitlist} creates data frame from a list created by fit\_counts function with additional attributes.
\end{itemize}
...
3   poisson     ZIP 0 18        NA
4   poisson     ZIP 1  7        NA
...
13 binomial      NB 0  7 12.168873
14 binomial      NB 1 18  8.761455
15 binomial    ZINB 0  7        NA
16 binomial    ZINB 1 18        NA
\end{example}
...
poisson_pois   poisson   0.28 0.1203040 0.5414518 35.04040        NA NA Poisson
binomial_pois binomial   0.72 0.4364839 1.1056323 51.04502        NA NA Poisson
poisson_zip    poisson     NA        NA        NA       NA        NA NA     ZIP
binomial_zip  binomial     NA        NA        NA       NA        NA NA     ZIP
poisson_nb     poisson   0.28 0.1203060 0.5414187 38.25952  7869.431 NA      NB
binomial_nb   binomial   0.72 0.4364790 1.1056475 54.26417 47031.937 NA      NB
poisson_zinb   poisson     NA        NA        NA       NA        NA NA    ZINB
binomial_zinb binomial     NA        NA        NA       NA        NA NA    ZINB
\end{example}
